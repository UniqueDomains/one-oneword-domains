# Available .ONE One-Word Domains (5,621,926)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C428%20rows-8250df">
...
> **Important:** this repository is a **public 6,428-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 6,428 rows · **Live catalog:** 5,621,926 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/one?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/one?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./one.csv">CSV</a> / <a href="./one.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .ONE search](https://unique.domains/domains/tld/one?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .ONE search](https://unique.domains/domains/tld/one?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_one_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./one.csv) or [Download JSON](./one.json)
...
- `one.csv` — public CSV extract (6,428 rows)
- `one.json` — public JSON extract (6,428 rows)
...
| ----------------------- | ------------------------------------------------ |
| 6,428-row public sample | 5,621,926 live domains                           |
...
| sideways.one  | available | $30.98    | —             | 70             | 13     | 8      | namecheap                               |
| shot.one      | resell    | —         | —             | 116            | 98     | 4      | Spaceship, Inc.                         |
| free.one      | premium   | $6,250    | $6,250        | 88             | 59     | 4      | name.com                                |
| creepy.one    | available | $30.98    | —             | 60             | 13     | 6      | namecheap                               |
| ancient.one   | resell    | —         | —             | 92             | 98     | 7      | Key-Systems LLC                         |
| live.one      | premium   | $6,250    | $6,250        | 108            | 55     | 4      | name.com                                |
...
| earned.one    | available | $30.98    | —             | 72             | 12     | 6      | namecheap                               |
| canadian.one  | resell    | —         | —             | 88             | 98     | 8      | Dynadot Inc                             |
| fast.one      | premium   | $6,250    | $6,250        | 82             | 53     | 4      | name.com                                |
| confirmed.one | available | $30.98    | —             | 69             | 12     | 9      | namecheap                               |
| taiwan.one    | resell    | —         | —             | 66             | 92     | 6      | PDR Ltd. d/b/a PublicDomainRegistry.com |
| true.one      | premium   | $6,250    | $6,250        | 86             | 52     | 4      | name.com                                |
| satanic.one   | available | $30.98    | —             | 48             | 12     | 7      | namecheap                               |
| chase.one     | resell    | —         | —             | 66             | 87     | 5      | NameSilo, LLC                           |
...
> Unique Domains. *Available .ONE One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.

...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C432%20rows-8250df">
...
> **Important:** this repository is a **public 6,432-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 6,432 rows · **Live catalog:** 5,621,926 domains
...
- `one.csv` — public CSV extract (6,432 rows)
- `one.json` — public JSON extract (6,432 rows)
...
| ally.one      | resell    | —         | —             | 68             | 85     | 4      | GoDaddy.com, LLC                        |
...
| ----------------------- | ------------------------------------------------ |
| 6,432-row public sample | 5,621,926 live domains                           |
...
> Unique Domains. *Available .ONE One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
